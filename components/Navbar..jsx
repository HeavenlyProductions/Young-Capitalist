...
const Navbar = () => {
  return (
    <div
      className="flex justify-between items-center px-10 py-3 mb-10 
    border-b border-b-gray-300"
    >
      <div>
        <h1 className="font-extrabold text-[26px] tracking-[-0.5px]">
          YOUNG CAPITALIST
        </h1>
        <div className="flex gap-4 text-[10px] tracking-wider font-extralight">
